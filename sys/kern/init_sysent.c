...
struct sysent sysent[] = {
	...
	{ .sy_narg = AS(zswap_interface_args), .sy_call = (sy_call_t *)sys_zswap_interface, .sy_auevent = AUE_ZSWAP_INTERFACE, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 583 = zswap_interface */
};
